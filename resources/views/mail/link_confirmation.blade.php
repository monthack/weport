...
<html lang="es">
    <head>
        ...
        <title>Notificación de usuarios verificados</title>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#F2F2F2">
                <tr>
                    <td align="center" valign="top">
                                    ...
                                    <table width="500" cellpadding="0" cellspacing="0" border="0" class="container">
                                        <tr>
                                            <td align="left" valign="top">
                                                <font size="5" color="#496281" face="Arial" style="font-family: 'Roboto', 'Arial', 'sans-serif';"><b style="font-weight: bold;">Estimado(a) {{$user_name}}</b></font>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                ...
                                <td align="center" valign="top">
                                    <table width="500" cellpadding="0" cellspacing="0" border="0" class="container">
                                        <tr>
                                            <td align="left" valign="top">
                                                <p>
                                                    <font size="3" color="#333333" face="Arial" style="font-family: 'Roboto', 'Arial', 'sans-serif';">El usuario <b style="font-weight: bold">{{$employed_name}}</b> ha verificado su correo de manera exitosa!.</font>
                                                </p>
                                            </td>
                                        </tr>
                                    </table>
                        ...
                        <table width="640" cellpadding="0" cellspacing="0" border="0" class="wrapper" bgcolor="#89CDEF">
                            <tr>
                                <td height="30" style="font-size:10px; line-height:10px;">&nbsp;</td>
                            </tr>
                            <tr>
                                    ...
                                    <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                                        <tr>
                                            <td width="400" class="mobile" align="left" valign="top">
                                                <font size="2" color="#ffffff" face="Arial" style="font-family: 'Roboto', 'Arial', 'sans-serif';">Montserrat Vazque Manrique♡ © 2021. Todos los derechos reservados. </font>
                                                <br><br>
